...
function print3 (earn:number, house:boolean, charm:string) {
  let point:number = earn;
  if (house) point + 500;
  if (charm === '상') point + 100;
